import{P as r}from"./index-DQsREHK2.js";import{s}from"./utils-CFjXnQ4s.js";async function n(){const o=document.getElementById("accolade-list");try{const a=await fetch(`${r.apiBase}/api/accolades`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const{accolades:e}=await a.json();o.innerHTML=e.map(t=>`
