import{P as s}from"./index-DgYdFkUY.js";function i(n,t){const o={weekday:"short",month:"long",day:"numeric",hour:"2-digit",minute:"2-digit",timeZoneName:"short"},e=new Date(n).toLocaleString(void 0,o),a=t&&new Date(t).getFullYear()>1970?new Date(t).toLocaleString(void 0,o):"";return a?`${e} – ${a}`:`${e}`}function c(n){return n.split(`
