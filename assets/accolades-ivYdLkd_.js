import{P as s}from"./index-DZoLW-p4.js";import{s as r}from"./utils-CFjXnQ4s.js";async function n(){const o=document.getElementById("accolade-list");try{const a=await fetch(`${s.apiBase}/api/accolades`);if(!a.ok)throw new Error(`HTTP ${a.status}`);const{accolades:e}=await a.json();o.innerHTML=e.map(t=>`
